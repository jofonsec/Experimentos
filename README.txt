...
##En la linea de comandos, ir al sub-directorio build (se debe crear) del trabajo e ingresar los siguiente comando:
...
> mingw32-make instalar //para copiar los archivos matriz, nodos y .param
